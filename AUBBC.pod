...
This bbcode takes a "garbage in garbage out" approach in coveting most
of its built-in BBcode tags. This does not mean that the tags will brake or
invalidate HTML/XHTML. What it means is users can use tags in ways that can invalidate
HTML/XHTML and if the user knows HTML/XHTML they can also use the correct
tags to produce valid HTML/XHTML. None of the tags should brake the theme
since there is no <div> or table tags.

Please report anything you think is a bug to bug-AUBBC@rt.cpan.org or shakaflex@gmail.com
